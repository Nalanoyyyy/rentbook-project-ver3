...
const HowToRent: React.FC = () => {
  // ข้อมูลขั้นตอนการเช่า
  const steps = [
    {
      id: '01',
      title: 'เลือกหนังสือที่ชอบ',
      description: 'ค้นหาหนังสือจากการ์ตูน นิยาย หรือหนังสือทั่วไปที่คุณต้องการอ่านผ่านหน้าแรก',
      icon: 'menu_book',
    ...
    },
    {
      id: '02',
      title: 'เพิ่มลงตะกร้า',
      description: 'กดปุ่มเช่าหนังสือที่คุณต้องการ และเลือกจำนวนวันที่ต้องการเช่า',
      icon: 'shopping_basket',
      color: 'bg-primary/10 text-primary'
    },
    {
      id: '03',
      title: 'ชำระเงินและรอรับ',
      description: 'ตรวจสอบที่อยู่จัดส่งและชำระเงิน ระบบจะดำเนินการจัดส่งหนังสือถึงบ้านคุณ',
      icon: 'local_shipping',
    ...
    },
    {
      id: '04',
      title: 'อ่านและส่งคืน',
      description: 'เมื่อครบกำหนดเวลาเช่า ให้ส่งคืนหนังสือผ่านจุดบริการขนส่งที่คุณสะดวก',
    ...
    <main className="max-w-5xl mx-auto px-4 py-20 mt-10">
      ...
      <div className="bg-primary rounded-[3rem] p-12 text-center text-white shadow-2xl shadow-primary/20">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center">
          ...
          <Link to="/" className="px-10 py-4 bg-primary-dark/20 border border-white/20 rounded-2xl font-bold hover:bg-white/10 transition-all">
            เลือกดูหนังสือ
          </Link>
        </div>
      </div>
