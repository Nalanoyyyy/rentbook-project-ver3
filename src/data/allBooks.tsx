...
export interface Book {
  ...
  isAvailable: boolean;
  category: string;
  status?: string; // เพิ่มหมวดหมู่เพื่อใช้ในหน้า Detail
}
...
export const allBooks: Book[] = [
    ...
    { id: 103, title: "Watchmen", author: "Alan Moore",category: "cartoon, แอคชั่น", image: "https://picsum.photos/seed/c3/300/400", price: 55, isAvailable: true },
    ...
    { id: 106, title: "Bone", author: "Jeff Smith",category: "cartoon, ดราม่า", image: "https://picsum.photos/seed/c6/300/400", price: 40, isAvailable: true },
    ...
    { id: 110, title: "Attack on Titan", author: "Hajime Isayama",category: "cartoon, แอคชั่น, แฟนตาซี, มังงะ", image: "https://picsum.photos/seed/c10/300/400", price: 60, isAvailable: true },
    ...
    { id: 117, title: "Black Clover", author: "Yūki Tabata",category: "cartoon, แฟนตาซี, มังงะ", image: "https://picsum.photos/seed/c17/300/400", price: 50, isAvailable: true },
    ...
    { id: 119, title: "Jujutsu Kaisen", author: "Gege Akutami",category: "cartoon, แอคชั่น, แฟนตาซี, ดราม่า, มังงะ", image: "https://picsum.photos/seed/c19/300/400", price: 55, isAvailable: true },
    ...
    { id: 201, title: "The Dutch House", author: "Ann Patchett", category: "fiction, สืบสวน", image: "https://picsum.photos/seed/f1/300/400", price: 45, isAvailable: true },
    ...
    { id: 203, title: "The Night Circus", author: "Erin Morgenstern", category: "fiction, ไซไฟ", image: "https://picsum.photos/seed/f3/300/400", price: 50, isAvailable: true },
    ...
    { id: 205, title: "The Giver of Stars", author: "Jojo Moyes", category: "fiction, โรแมนติก, ดราม่า", image: "https://picsum.photos/seed/f5/300/400", price: 45, isAvailable: true },
    ...
    { id: 208, title: "The Shadow of the Wind", author: "Carlos Ruiz Zafón", category: "fiction, แฟนตาซี, สืบสวน", image: "https://picsum.photos/seed/f8/300/400", price: 45, isAvailable: true },
    ...
    { id: 210, title: "The Road", author: "Cormac McCarthy", category: "fiction,สืบสวน", image: "https://picsum.photos/seed/f10/300/400", price: 40, isAvailable: true },
    ...
    { id: 302, title: "Project Hail Mary", author: "Andy Weir",category: "general, จิตวิทยา", image: "https://picsum.photos/seed/2/300/400", price: 60, isAvailable: true },
    ...
    { id: 306, title: "Lessons in Chemistry", author: "Bonnie Garmus", category: "general, ประวัติศาสตร์", image: "https://picsum.photos/seed/6/300/400", price: 45, isAvailable: true },
    ...
    { id: 308, title: "The Henna Artist", author: "Alka Joshi",category: "general, ธุรกิจ", image: "https://picsum.photos/seed/8/300/400", price: 35, isAvailable: true },
    ...
    { id: 310, title: "The Tattooist of Auschwitz", author: "Heather Morris", category: "general, จิตวิทยา", image: "https://picsum.photos/seed/10/300/400", price: 45, isAvailable: true },
    ...
    { id: 312, title: "The Goldfinch", author: "Donna Tartt", category: "general, ประวัติศาสตร์", image: "https://picsum.photos/seed/12/300/400", price: 50, isAvailable: true },
];
